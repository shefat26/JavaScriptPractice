...
// .sort()
// sort the array with alphabetical order, Capital letter will be sorted first
// it will also sort number from lower order to higher order
// if we have numerick value & Alphavetical value, so Numaric will come first



// Example:-  1
let gadget = ["macbook", "imac", "samsung", "canon"];

let newGadget = gadget.sort();
...
//Example:- 2
let gadget1 = ["macbook", "imac", "samsung", "canon", "Apple Ipad", 
                 "124 watch",  "450 cars"];

let newGadget1 = gadget1.sort();
console.log(newGadget1);
...
// EXAMPLE:-  3
let sortNum = [1, 4, 2, 3, 5, 8, 6, 9, 11, 22, 10, 7, 0]

// Here it will sort "0", "1", "10", "11", 2, 3, 4, 5, 6,,7,8,9
/* 1st it will choose numaric value lowar order to higher order,
also it will choose lower numaric valu tha has other lower Numaric value
*/
...
let srtNum = [1, 4, 2, 3, 5, 8, 6, 9, 11, 22, 10, 7, 0];
...
console.log("\nSortted Arr Function:-",myFunction(srtNum))
